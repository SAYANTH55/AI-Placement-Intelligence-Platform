...
import { LayoutDashboard, FileText, Target, Activity, Briefcase, LogOut, X, CheckCircle } from 'lucide-react';
                    ...
                    <nav className="space-y-0.5">
                        {menuItems.map((item) => (
                            ...
                            >
                                {({ isActive }) => (
                                    <>
                                        <span className={isActive ? 'text-[#1B2A4A]' : 'text-gray-400'}>
                                            {item.icon}
                                        </span>
                                        {item.name}
                                    </>
