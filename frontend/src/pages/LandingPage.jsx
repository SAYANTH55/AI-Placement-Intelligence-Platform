            ...
            <div className="hidden lg:flex items-center gap-10 font-medium text-[#64748B]">
              {['Home', 'Features', 'How it Works', 'Contact'].map((link, i) => (
                 <a 
                   key={i} 
                   href="#" 
                   className="relative group hover:text-[#F97316] transition-colors duration-200"
                 >
                   {link}
            ...
            <div className="bg-[#FFFFFF] rounded-3xl p-10 shadow-sm hover:-translate-y-[5px] hover:shadow-lg transition-all duration-200 ease-in-out relative hardware-accelerated group/card">
              ...
              <form className="space-y-5">
                ...
                <div className="pt-4 flex flex-col gap-3">
                  <button 
                     type="button"
                     className="w-full bg-[#F97316] text-white py-4 rounded-xl font-bold text-base shadow-sm hover:scale-[1.03] hover:-translate-y-[2px] transition-all duration-200 ease-in-out hover:shadow-md hover:bg-orange-600 hardware-accelerated"
                  >
